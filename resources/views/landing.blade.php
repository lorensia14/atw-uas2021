    ...
    <div class="container">
      ...
      <div class="row align-items-center text-center text-md-left">
        <div class="col-md-6 col-lg-5 mb-5 mb-md-0">
          <h1>REN E-Commercial</h1><br>
          <h1>Kelola Penjualan</h1>
          <p>
          	REN E-Commercial, Aplikasi yang bisa anda gunakan untuk melihat data penjualan, data transaksi, riset penjualan, dsb. 
          </p>
